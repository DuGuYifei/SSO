...
public class ManagementControllerTest {
         ...
         * "/api/v1/management/analysis-longest-five"
         *
        ...
        /**
         * This test method sends a Get request to the
         * "/api/v1/management/analysis-shortest-five"
         *
         * @throws Exception Exception of mockMvc.perform
         */
        @Test
        ...
        public void testAnalysisShortestNoContent() throws Exception {
                ...
                // Send request to analysis-longest-five endpoint with valid cookie but no
                // content
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                                .get("/api/v1/management/analysis-longest-five")
                                .cookie(cookie)
        ...
        public void testAnalysisShortestInvalidToken() throws Exception {
                // Arrange
                // Send request to analysis-longest-five endpoint with invalid authorization
                // token
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                                .get("/api/v1/management/analysis-longest-five")
                                .param("numThreads", "5")
        ...
        /**
         * This test method test successfully send a post request to the
        ...
        public void testGenerateReportNoToken() throws Exception {
                ...
                mockMvc.perform(requestBuilder)
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.message")
                                                .value("A validation error occured: No token found in cookies"));
        }

        /**
         * This test method test successfully send a get request to the
         * "/api/v1/management/perform-test-on-database"
         *
         * @throws Exception if the test fails
         */
        @Test
