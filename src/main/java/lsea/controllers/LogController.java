...
public class LogController {
     ...
     */
    @PostMapping
    public ResponseEntity<SuccessResult> createOne(@RequestBody CreateLogDto dto, HttpServletRequest request)
            throws GenericForbiddenError, ValidationError {
    ...
    public ResponseEntity<SuccessResult> createOne(@RequestBody int N, HttpServletRequest request)
            throws GenericForbiddenError, ValidationError {
        String token = ValidationRouter.getTokenFromRequest(request);
