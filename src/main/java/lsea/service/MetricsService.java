...
public class MetricsService {
        ...
        /**
         * Constructs a new instance of MetricsService class with MetricsIndex
         * 
         * @param metricsIndex the metrics index of the application
         */
        ...
        public void updateMemoryMetrics() {
                ...
                this.metricsIndex.setMemoryUsagePercent(
                                (double) this.metricsIndex.getMemoryUsage() / this.metricsIndex.getTotalMemory());
        }
        ...
        public void updateRequestMetrics() {
                ...
                this.metricsIndex.setIndexRequestCount(
                                (int) requestMeterRegistry.counter("request.count", "controller", "IndexController")
                                                .count());
                this.metricsIndex.setLogRequestCount(
                                (int) requestMeterRegistry.counter("request.count", "controller", "LogController")
                                                .count());
                this.metricsIndex.setManagementRequestCount(
                                (int) requestMeterRegistry
                                                .counter("request.count", "controller", "ManagementController")
                                                .count());
                this.metricsIndex.setUserRequestCount(
                                (int) requestMeterRegistry.counter("request.count", "controller", "UserController")
                                                .count());
                this.metricsIndex.setWebsiteRequestCount(
                                (int) requestMeterRegistry.counter("request.count", "controller", "WebsiteController")
                                                .count());
                this.metricsIndex
                                .setGetRequestCount((int) requestMeterRegistry.counter("request.count", "method", "GET")
                                                .count());
                this.metricsIndex
                                .setPostRequestCount((int) requestMeterRegistry
                                                .counter("request.count", "method", "POST").count());
        }
