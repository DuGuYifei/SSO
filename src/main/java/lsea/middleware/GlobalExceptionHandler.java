...
/**
 * This class acts as a global exception handler for HTTP errors and unknown exceptions.
 * It catches exceptions thrown by the controllers and returns an appropriate response to the client.
 */
...
public class GlobalExceptionHandler {
    ...
    /* Requirement 2.7 */
    /**
     * This method handles HttpBaseError exceptions and returns an HTTP response with the appropriate status code and message.
    ...
    /* Requirement 2.7 */
    /**
     * This method handles unknown exceptions and returns an HTTP response with a 422 status code and a generic error message.
